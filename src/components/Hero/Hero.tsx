        ...
        <div className="hero-left-col">
          ...
          <div className="hero-subtitle-box">
            ...
            <div className="hero-scroll-btn">
              ...
              <img src={shapeIcon} alt="Shape" className="hero-scroll-shape" />
            </div>
          </div>
        </div>
            ...
            <div className="hero-card-top">
              <div className="hero-image-wrapper">
                ...
                <div className="hero-play-btn">
                  <img src={playButtonIcon} alt="Play Video" className="w-28 h-28" />
                </div>
              </div>
              <div className="hero-stats-wrapper">
                <div>
                  <h3 className="hero-stat-num">12K+</h3>
                  <p className="hero-stat-desc">{t('hero.stats.projects')}</p>
                </div>
                <div>
                  <h3 className="hero-stat-num">7K+</h3>
                  <p className="hero-stat-desc">{t('hero.stats.clients')}</p>
                </div>
                <div>
                  <h3 className="hero-stat-num">10+</h3>
                  <p className="hero-stat-desc">{t('hero.stats.years')}</p>
                </div>
                <div>
                  <h3 className="hero-stat-num">270+</h3>
                  <p className="hero-stat-desc">{t('hero.stats.awards')}</p>
                </div>
              </div>
            </div>
            <div className="hero-card-bottom">
              <div className="hero-bottom-group">
                <img loading="lazy" src={groupIcon} alt="Users Group" className="hero-group-img" />
                <div>
                  <h4 className="hero-group-title">{t('hero.groupTitle')}</h4>
                  <p className="hero-group-desc">{t('hero.groupDesc')}</p>
                </div>
              </div>
            </div>
          </div>
